...
_FAMILY_BY_RESOURCE = {
    ...
    "host": ["host", "hardware_node", "esxi_host", "vsphere_vm", "vsphere_cluster", "vsphere_datastore",
    ...
    "cloud": ["azure_subscription", "azure_app_service", "azure_app_service_plan", "azure_function",
              ...
              "azure_traffic_manager", "azure_redis",
              "azure_container_registry"],
    "network": ["network_device", "network_path", "network_tunnel", "dns_zone",
                "network_circuit", "network_firewall", "network_security_group",
